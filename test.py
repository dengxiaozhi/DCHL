...
from modules import resnet, network_cross, transform
...
if __name__ == "__main__":
    ...
    for e in range(args.start_epoch, 1001, 100):
        res = resnet.get_resnet(args.resnet)
        model = network_cross.Network(res, args.feature_dim, class_num)
        model_fp = os.path.join(args.model_path, "checkpoint_{}.tar".format(e))
        ...
        print('CC_cross: epoch {} NMI = {:.4f} ARI = {:.4f} F = {:.4f} ACC = {:.4f}'.format(e, nmi, ari, f, acc))
